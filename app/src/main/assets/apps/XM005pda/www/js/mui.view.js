...
(function($, window) {
	...
	var View = $.Class.extend({
		init: function(element, options) {
			...
			this._initPageEventMethod();//初始化事件。
		...
		_appendPage: function(page) {
			...
			page.classList.add(CLASS_PAGE_CENTER);//"mui-page-center
		...
		_prependNavbar: function(navbar) {
			...
			this.navbars&&this.navbars.insertBefore(navbar, this.navbars.firstElementChild);
		},
		_appendNavbar: function(navbar) {
			navbar.classList.add(CLASS_NAVBAR_CENTER);
			this.navbars&&this.navbars.appendChild(navbar);
		},
